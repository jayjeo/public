...
### NOTES 3:
  * I have shared a final data file generated by ONET_ESCO_Matching.py, which represents the last step of the process. Therefore, if you wish to bypass all the procedures in the 'ESCO vs ONET Comparison' section, you can directly download the files from the provided link:
