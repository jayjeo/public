...
################## using SVARdata_seasonadjusted.csv ##################
...
################## using SVARdata(heavyTFW)_seasonadjusted.csv ##################
...
SVARdata <- read.csv("https://raw.githubusercontent.com/jayjeo/public/master/LaborShortage/SVARdata(heavyTFW)_seasonadjusted.csv")
SVARdata <- ts (SVARdata, frequency = 12, start = c(2014, 1))
...
model <- uhlig.penalty(Y=SVARdata, nlags=4, draws=2000, subdraws=1000, nkeep=1000, KMIN=1, KMAX=3, constrained=constr, constant=FALSE, steps=120, penalty=100, crit=0.001)
