...
################## using SVARdata(alternativeproduction).csv ##################
###### Import data and set sign restrictions
...
SVARdata <- read.csv("https://raw.githubusercontent.com/jayjeo/public/master/LaborShortage/SVARdata_seasonadjusted(alternativeproduction).csv")
...
vl <- c("Foreign Workers","Domestic Workers","Production Shock","Unemployment rate","Vacancy rate","Prod Domestic","Prod Abroad","Match Eff","Termination rate","Part/Full")
...
model3 <- rwz.reject(Y=SVARdata, nlags=4, draws=200, subdraws=200, nkeep=1000, KMIN=1, KMAX=3, constrained=constr, constant=FALSE, steps=120)
...
model2 <- uhlig.reject(Y=SVARdata, nlags=4, draws=200, subdraws=200, nkeep=1000, KMIN=1, KMAX=3, constrained=constr, constant=FALSE, steps=120)
